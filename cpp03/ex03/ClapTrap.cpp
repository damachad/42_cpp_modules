...
ClapTrap::ClapTrap(std::string name, unsigned int hp, unsigned int ep, unsigned int attack) : _name(name), _hit_points(hp), _energy_points(ep), _attack_damage(attack)
{
...
{
	std::cout << this->getName() << "'s health Points: " << this->_hit_points << std::endl;
	return (this->_hit_points);
}

unsigned int	ClapTrap::getEp(void)
{
	std::cout << this->getName() << "'s energy Points: " << this->_energy_points<< std::endl;
